...
describe('contest-header', () => {
  ...
  it('ContestHeader D should display winner filename when contest is complete', () => {
    ...
    const winnerMetadata: ImageMetadata = { filename: 'winner.jpg', height: 1080, size: 100_000, width: 1920 }
  ...
  it('ContestHeader E should not display image info during contest mode', () => {
    render(<ContestHeader contestState={mockContestState} leftImageMetadata={{ filename: 'image1.jpg', height: 800, size: 50_000, width: 600 }} rightImageMetadata={{ filename: 'image2.jpg', height: 800, size: 60_000, width: 600 }} />)
  ...
  it('ContestHeader F should not have a title when no contest state is provided', () => {
    render(<ContestHeader leftImageMetadata={{ filename: 'image1.jpg', height: 800, size: 50_000, width: 600 }} rightImageMetadata={{ filename: 'image2.jpg', height: 800, size: 60_000, width: 600 }} />)
